...
# calibration data
#calsum <- read_csv("C:\\Users\\sbecker14\\Documents\\GRScalibration\\GRScalibrationanalysis\\Data\\CalibrationDataK40andBWE2023-11-06.csv")

#grav_swc <- read.csv("C:\\Users\\sbecker14\\Documents\\GRScalibration\\RecommendationAnalysisAll27\\Weighting\\WeightedSWCData\\V_Wt_Avg_2023-11-08.csv")

veg <- read.csv(paste0(mainDir, "\\CsvFiles\\CalibrationDataVeg.csv"))

k40 <- read.csv(paste0(mainDir, "\\CsvFiles\\CalibrationDataK40.csv"))

grav_swc <- read.csv(paste0(mainDir, "\\CsvFiles\\V_Wt_Avg_2024-01-25.csv"))
...
FinalRes <- read.csv("C:\\Users\\sbecker14\\Documents\\GRScalibration\\gSMS_FieldValidation_Supplementals\\NumberCalibrationsOutput_2024-01-26BootstrapResults2024-01-26.csv")
...
ggsave(ResPlotAdj, file = paste0(outDir, "\\RMSEvsSampleSize_", stamp, ".tiff"),width = 6, height = 6, units = "in", dpi = 300 )
