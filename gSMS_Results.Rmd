...
**Figure 4.** The experimental relationship between total water and K-40 compared to the relationship predicted by Eq. 0 (black line) and the corresponding 95% confidence interval.
...
**Figure 6b.** A time series summary of the 2022 sampling period. In the upper panel are the daily K-40 data, the gravimetric sample data, and the predictions from Eq. 1 and Eq. 2. with 95% confidence intervals calculated by bootstrapping. The lower panel shows precipitation events and estimated biomass water equivalence (BWE). Vertical dashed lines are the sampling dates.
...
**Figure 6c.** A time series summary of the 2023 sampling period. In the upper panel are the daily K-40 data, the gravimetric sample data, and the predictions from Eq. 1 and Eq. 2. with 95% confidence intervals calculated by bootstrapping. The lower panel shows precipitation events and estimated biomass water equivalence (BWE).  Vertical dashed lines are the sampling dates.
...
**Figure 5**  a) Residuals from Eq. 1. The red line shows the significant linear trend (slope and intercept p-values < 0.01). b) Residuals from Eq. 2, where there is not a significant trend.  